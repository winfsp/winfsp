...
WinFsp does not currently ship or maintain an official Node.js/JavaScript binding. Node.js users can use a third-party package that targets FUSE/WinFsp, or create a Node-API native addon against the WinFsp native or FUSE API. Third-party projects are not part of WinFsp and should be evaluated independently.
