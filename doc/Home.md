...
- The [[Service Architecture|WinFsp-Service-Architecture]] document discusses how to integrate a file system into Windows as a service and the reasons to do so.
