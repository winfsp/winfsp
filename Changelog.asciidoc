...
* [FUSE] FUSE has new `--ExactFileSystemName=FSNAME` options that removes the "FUSE-" prefix from the file system name. (Use with caution: see discussion in PR #251.) (Thanks @johntyner.)
